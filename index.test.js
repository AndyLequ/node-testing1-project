...
describe('[Exercise 6] Car', () => {
  ...
  test('[15] driving the car returns the updated odometer', () => {
    ...
    expect(focus.drive(50)).toBe(60)

  })
  test('[16] driving the car uses gas', () => {
    focus.drive(10)
    expect(focus.tank).toBe(19.666666666666668)
    focus.drive(50)
  ...
  test('[17] refueling allows to keep driving', () => {
    ...
    focus.drive(50)
    focus.refuel(10)
    expect(focus.tank).toBe(28)
    expect(focus.drive(50)).toBe(110)
  })
  test('[18] adding fuel to a full tank has no effect', () => {
    focus.refuel(10)
    expect(focus.tank).toBe(30)
  })
})
